...
describe "Taxa" do
  before(:each) do
    ...
    # aaa = FactoryGirl.create(:taxonomy, superkingdom_id: 2, phylum_id: 1, klass_id: 1, order_id: 1, family_id: 1, genus_id: 1, species_id: 1, strain_id: 4, created_at: "2013-08-19 12:44:13", updated_at: "2013-08-19 12:44:13")
    puts "Ura2"
